...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Login_vue__ = __webpack_require__(1613);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_857fd648_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__ = __webpack_require__(1912);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_857fd648_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__["a" /* default */],
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-857fd648", Component.options)
  } else {
    hotAPI.reload("data-v-857fd648", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_libphonenumber_js__ = __webpack_require__(439);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function created() {
    ...
    this.$root.$on('attached-phone', function () {
      ...
      _this.$store.dispatch('auth/getUserByAPI').then(function (user) {
        ...
        _this.$store.dispatch('board/casting/setHasNewCastingsData', true);
        if (isRegistered) {
  ...
  watch: {
    'fields.login': function fieldsLogin(val) {
      if (!val) {
  ...
  mounted: function mounted() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_7__utils__["n" /* isBrowser */] && Object(__WEBPACK_IMPORTED_MODULE_7__utils__["l" /* has */])(this.$route.params, 'social') && Object(__WEBPACK_IMPORTED_MODULE_7__utils__["l" /* has */])(this.$route.query, 'code')) this._handleOAuth();
    if (__WEBPACK_IMPORTED_MODULE_7__utils__["n" /* isBrowser */]) {
      this._checkOldVersion();
      setTimeout(function () {
        _this2._checkOldVersion();
      }, 1000);
    }
  },

  methods: {
    _checkOldVersion: function _checkOldVersion() {
      this.isNative = Object(__WEBPACK_IMPORTED_MODULE_7__utils__["o" /* isNative */])();

      if (Object(__WEBPACK_IMPORTED_MODULE_7__utils__["q" /* isNativeIOS */])() && Object(__WEBPACK_IMPORTED_MODULE_7__utils__["z" /* versionCompare */])('4.2.3', window.nsWebViewInterface._iosAppInfo.version)) {
        this.oldVersionApp = true;
      }

      if (Object(__WEBPACK_IMPORTED_MODULE_7__utils__["p" /* isNativeAndroid */])() && Object(__WEBPACK_IMPORTED_MODULE_7__utils__["z" /* versionCompare */])('4.2.5', window.nsWebViewInterface._androidAppInfo.version)) {
        this.oldVersionApp = true;
      }
    },
      ...
      this._handleValidateFields().then(function () {
        ...
        validator.verify(login, 'email').then(function (_ref) {
          ...
          if (valid) {
            ...
            var phone = Object(__WEBPACK_IMPORTED_MODULE_5_libphonenumber_js__["b" /* parsePhoneNumberFromString */])(login, 'RU');
    ...
    _handleClickOAuthApple: function _handleClickOAuthApple() {
      ...
      this.$nativeOAuth.appOAuth(__WEBPACK_IMPORTED_MODULE_6__modules_oauth_native__["a" /* APPLE */]).then(function (data) {
        if (!Object(__WEBPACK_IMPORTED_MODULE_7__utils__["l" /* has */])(data, 'code')) return _this17._handleError();

        var code = data.code;

        _this17._attemptSign(_this17.$api.post('oauth/mobile/apple/callback?code=' + code)).then(function (r) {}, function (e) {});
      }).catch(function (e) {
        _this17.$oauth.appleAuth().then(function (data) {
          var social = data.social,
              code = data.code;
...
var update = __webpack_require__(4)("7ef07846", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-857fd648\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Login.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-857fd648\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Login.vue");
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "column justify_center align_flex-end position_relative input__password"
                                },
                                [
                                  ...
                                  _vm.fields.password.length > 0
                                    ? [
                                        _c("div", {
                                          ...
                                          on: {
                                            click:
                                              _vm._handleClickSwitchVisibilityPassword
                                          }
                                        })
                                      ]
                                    : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-857fd648", esExports)
  }
}
...
//# sourceMappingURL=213.build.8ff91b956a5070c8f3f4.js.map