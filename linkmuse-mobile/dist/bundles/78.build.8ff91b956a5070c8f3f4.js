...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Create_vue__ = __webpack_require__(1619);
...
/* scopeId */
var __vue_scopeId__ = "data-v-5340bb68"
...
Component.options.__file = "src/views/Board/Castings/Create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5340bb68", Component.options)
  } else {
    hotAPI.reload("data-v-5340bb68", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mint_ui__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mint_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_mint_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_Board_mixins_form_js__ = __webpack_require__(1512);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_Rating_Enums_events__ = __webpack_require__(438);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Board_Casting_mixins_form__ = __webpack_require__(1561);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_Board_Casting_extends_Form_vue__ = __webpack_require__(1563);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_Board_Casting_Enums_CastingTransition__ = __webpack_require__(1537);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  extends: __WEBPACK_IMPORTED_MODULE_5__modules_Board_Casting_extends_Form_vue__["a" /* default */],
  mixins: [__WEBPACK_IMPORTED_MODULE_2__modules_Board_mixins_form_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_4__modules_Board_Casting_mixins_form__["a" /* default */]],
  metaInfo: {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all([store.dispatch('board/casting/getSources'), store.dispatch('board/casting/clearCastingFields')]);
  ...
  mounted: function mounted() {
    if (this.isAuthorized && this.user) {
      if (Object(__WEBPACK_IMPORTED_MODULE_0__utils__["l" /* has */])(this.user, 'country.id') && this.user.country.id) {
        this.fields.countryId = this.user.country.id;
      }
      if (this.fields.countryId && Object(__WEBPACK_IMPORTED_MODULE_0__utils__["l" /* has */])(this.user, 'city.id') && this.user.city.id) {
        this.fields.cityId = this.user.city.id;
      }
    }

    var fields = this.$localStorage.get('board.create', null, Object);
  ...
  methods: {
    ...
    _handleClickCreateCasting: function _handleClickCreateCasting(transition) {
      var _this2 = this;

      this.fields.transition = transition;
      this.$nextTick(function () {
        _this2._handleValidateFields().then(function () {
          _this2._createCasting().then(function () {
            var username = _this2.user.username;
            var transition = _this2.fields.transition;

            _this2.$localStorage.remove('board.create');
            _this2.$store.dispatch('board/casting/setHasNewCastingsData', true);

            if (transition === __WEBPACK_IMPORTED_MODULE_6__modules_Board_Casting_Enums_CastingTransition__["b" /* PUBLISH */]) {
              if (Object(__WEBPACK_IMPORTED_MODULE_0__utils__["l" /* has */])(_this2.profile, 'without_moderate.castings') && _this2.profile['without_moderate']['castings']) {
                Object(__WEBPACK_IMPORTED_MODULE_1_mint_ui__["Toast"])({ message: 'Кастинг опубликован', iconClass: 'mintui mintui-success' });
                _this2.$router.push({ name: 'board.castings.index' });
              } else {
                var openSuccessCreateBoardModal = _this2.$localStorage.get('success.board.create', false, Boolean);

                if (openSuccessCreateBoardModal === false) {
                  _this2.$modalRouter.push({ name: 'success.board.create' });
                } else Object(__WEBPACK_IMPORTED_MODULE_1_mint_ui__["Toast"])({ message: 'Кастинг отправлен на модерацию', iconClass: 'mintui mintui-success' });

                _this2.$router.push({ name: 'board.castings.user', params: { username: username } });
              }

              _this2.$nsWebViewInterface.emit('rating', __WEBPACK_IMPORTED_MODULE_3__modules_Rating_Enums_events__["a" /* createCasting */]);
            } else {
              Object(__WEBPACK_IMPORTED_MODULE_1_mint_ui__["Toast"])({ message: 'Кастинг сохранен в черновик', iconClass: 'mintui mintui-success' });
              _this2.$router.push({ name: 'board.castings.user', params: { username: username } });
            }
          }).catch(function () {
    ...
    _createCasting: function _createCasting() {
      var _this3 = this;
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (!Boolean(Number(_this3.fields.fee))) {
          _this3.$delete(data, 'feeAmount');
          _this3.$delete(data, 'feeTypeId');
          _this3.$delete(data, 'feeCurrencyId');
        }

        if (!Boolean(Number(_this3.isForActorAndModel))) {
          _this3.$delete(data, 'forTrusted');
        }

        _this3.$api.post('api/v2/boards/castings', data).then(function (response) {
    ...
    _handleClickClearForm: function _handleClickClearForm() {
      ...
      this._clearForm().then(function () {
        _this4.$gtm.trackEvent({ event: 'clear_form' });
    ...
    _clearForm: function _clearForm() {
      ...
      return new Promise(function (resolve, reject) {
        try {
          _this5.uploads = [];
          _this5.showFieldForm = false;
          _this5.$nextTick(function () {
            return _this5.showFieldForm = true;
          });
          _this5.fields = _this5._.cloneDeep(_this5.defaultFields);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("f6b84a82", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js?sourceMap!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5340bb68\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Create.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js?sourceMap!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5340bb68\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Create.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
//# sourceMappingURL=78.build.8ff91b956a5070c8f3f4.js.map