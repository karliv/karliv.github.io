...
export function SET_FIELD_CASTING_DATA (state, { key, value }) {
  _.set(state.casting.data, key, value)
}
/** END SINGLE CASTING */
...
export function SET_CASTINGS_HAS_NEW (state, value) {
  state.castings.hasNew = value
}

export function SET_CASTINGS_INITIALIZED (state, value) {
  state.castings.initialized = value
}
