...
const DEFAULT_STATUS_ORDER = 'Необработанный'
const DEFAULT_WORK = '-'
...
export const DEFAULT_VAT = 'НДС 0%'
  ...
  constructor () {
    ...
    this.dispute = {
      ...
      causes: {
        ...
        [INADEQUATE_STATE]: 'Неадекватное состояние /поведение',
        [DISCREPANCY]: 'Несоответствие правилам ',
      ...
      solutions: {
        ...
        [AGAIN]: 'Провести сертификацию еще раз',
