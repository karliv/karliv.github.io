...
export const api = (locale, context) => {
  const http = axios.create({
    ...
    adapter: throttleAdapterEnhancer(cacheAdapterEnhancer(axios.defaults.adapter, { enabledByDefault: false, cacheFlag: 'useCache' }))
  })
  ...
  const removeSession = () => {
    ...
    context.clearCookies.push('hasEmail')
  ...
  const refreshAccessToken = () => {
    ...
    const request = axios.post('api/v2/auth/refresh', {}, { headers })
