    ...
    <div class="modal__content_tree-professions">
      <div class="form_tree-professions">
        <div class="modal__content-professions_header">
          <div class="heading_h4">{{ $t('unified-profile.add-company.choose-specialization') }}</div>
          <div class="description_tree-professions">
            {{ $t('unified-profile.add-company.find') }}
          </div>
          ...
          <div class="input input_search input_search_feed">
            ...
            <input type="text" name="filterProfessions" ref="filterProfessions" autocomplete="off"
                   ...
                   :placeholder="$t('unified-profile.add-company.search')"
        ...
        <div class="form__controls__tree-professions">
          <div class="row">
            <button class="btn btn_secondary" @click="_handleCloseModal">
              {{ $t('unified-profile.add-company.back') }}
            </button>
          </div>
        </div>
      </div>
        ...
        tree: {
          ...
          options: {
            ...
            filter: {
              ...
              emptyText: `К сожалению, ничего не найдено. <p class="mt_2"> <a href="https://linkmuse.typeform.com/to/KrghZq" target="_blank" class="d-link">Вашей сферы деятельности нет в списке? Пройдите опрос и мы ее добавим</a></p>`
            }
          }
        }
      }
