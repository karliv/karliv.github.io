        ...
        <div class="form__section form__section_filters">
          <div class="form__group form__group_declaration">
            <div class="row row_justify_between">
              <div class="column mr_4">
                <div class="input">
                  <label for="rateCostOfWorkMin" class="input__label">{{ $t('unified-profile.filters.rate') }}</label>
                  <input v-mask-numeric type="text"
                         ...
                         :class="[{ 'error': (verrors.has('rateCostOfWorkMin')), 'filled': (fields.rateCostOfWorkMin && !verrors.has('rateCostOfWorkMin')) }, 'input__field', 'input__field_filters']">
                </div>
              </div>
              <div class="column">
                <div class="input">
                  ...
                  <input v-mask-numeric type="text"
                         ...
                         :class="[{ 'error': (verrors.has('rateCostOfWorkMax')), 'filled': (fields.rateCostOfWorkMax && !verrors.has('rateCostOfWorkMax')) }, 'input__field', 'input__field_filters']">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="form__group form__group_declaration">
            <label for="form__select_declaration_ratePeriodSelection" class="input__label">
              {{ $t('unified-profile.filters.payment-period') }}
            </label>
            <lm-select :class="['lm-m-filter-line', { 'filled': (fields.ratePeriodSelection), 'error': (verrors.has('ratePeriodSelection')) }]"
                       ...
                       :data-vv-as="$t('unified-profile.filters.payment-period')"
                       :placeholder="$t('unified-profile.filters.not-chosen')"
                       label=""
                       :multiple="false"
