      ...
      <div class="page-inner__container">
        <div class="page__body page-inner__body_declaration">
          ...
          <div class="block block_declaration">
            ...
            <div class="form__group form__group_declaration form__group_service">
              <label for="apple_id" class="label input__label">Apple id</label>
              ...
              <div class="column justify_center align_flex-end position_relative">
                ...
                <template>
                  <template v-if="(hasSocialAccountApple === true)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickDetachSocial('apple')">отвязать</a>
                  </template>

                  <template v-if="(hasSocialAccountApple === false)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickOAuthApple">привязать</a>
                  </template>
                </template>

                <input type="text" autocomplete="off"
                       id="apple_id" name="apple_id"
                       :placeholder="''"
                       :disabled="true"
                       :value="hasSocialAccountApple ? socialAccounts['apple']['uid'] : null"
                       class="d-input form__input form__input_declaration">
              </div>
            </div>

            <div class="form__group form__group_declaration form__group_service">
              <label for="fb_id" class="label input__label">Facebook</label>
              ...
              <div class="column justify_center align_flex-end position_relative">
                ...
                <template>
                  <template v-if="(hasSocialAccountFacebook === true)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickDetachSocial('facebook')">отвязать</a>
                  </template>

                  <template v-if="(hasSocialAccountFacebook === false)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickOAuthFacebook">привязать</a>
                  </template>
                </template>
                ...
                <input type="text" autocomplete="off"
                       ...
                       :placeholder="''"
                       :disabled="true"
                       :value="hasSocialAccountFacebook ? socialAccounts['facebook']['link'] || socialAccounts['facebook']['uid'] : null"
                       class="d-input form__input form__input_declaration">
              </div>
            </div>

            <div class="form__group form__group_declaration form__group_service">
              <label for="vk_id" class="label input__label">ВКонтакте</label>
              ...
              <div class="column justify_center align_flex-end position_relative">
                ...
                <template>
                  <template v-if="(hasSocialAccountVkontakte === true)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickDetachSocial('vkontakte')">отвязать</a>
                  </template>

                  <template v-if="(hasSocialAccountVkontakte === false)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickOAuthVk">привязать</a>
                  </template>
                </template>
                ...
                <input type="text" autocomplete="off"
                       ...
                       :placeholder="''"
                       :disabled="true"
                       :value="hasSocialAccountVkontakte ? socialAccounts['vkontakte']['link'] || socialAccounts['vkontakte']['uid'] : null"
                       class="d-input form__input form__input_declaration">
              </div>
            </div>

            <div class="form__group form__group_declaration form__group_service">
              <label for="google_id" class="label input__label">Google</label>
              ...
              <div class="column justify_center align_flex-end position_relative">
                ...
                <template>
                  <template v-if="(hasSocialAccountGoogle === true)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickDetachSocial('google')">отвязать</a>
                  </template>

                  <template v-if="(hasSocialAccountGoogle === false)">
                    <a href="javascript:void(0)" class="form__input_change-link" @click="_handleClickOAuthGoogle">привязать</a>
                  </template>
                </template>

                <input type="text" autocomplete="off"
                       id="google_id" name="google_id"
                       :placeholder="''"
                       :disabled="true"
                       :value="hasSocialAccountGoogle ? socialAccounts['google']['uid'] : null"
                       class="d-input form__input form__input_declaration">
              </div>
            </div>
          </div>
          ...
          <div class="block block_declaration">
            ...
            <template v-if="(hasEmail === false && disabled['email'] === true) || ((hasPhone === false && disabled['phone'] === true))">
              <div class="form__group form__group_declaration">
                <div class="section__hint">
                  <div class="heading heading_h5">
                    Подумайте о безопасности
                  </div>
                  <template v-if="(hasEmail === false && disabled['email'] === true)">
                  ...
                  <template v-else-if="(hasPhone === false && disabled['phone'] === true)">
                    <div class="color_gray-2 mb_2">
            ...
            <div class="form__group form__group_declaration">
              ...
              <template v-if="(disabled['phone'] === false)">
                <div class="d-row mt_4">
                  <button class="btn btn_primary" :disabled="(hasPhoneField === false)" @click="_handleClickAttachPhone">
            ...
            <div class="form__group form__group_declaration">
              ...
              <template v-if="(disabled['email'] === true && email['success'] === true)">
            ...
            <div class="form__group form__group_declaration">
              ...
              <div class="column justify_center align_flex-end position_relative">
                ...
                <input type="password" autocomplete="off" autocapitalize=off
                       ...
                       :data-vv-as="$t('unified-profile.profile-settings.password')" :placeholder="'******'"
                       v-validate="'min:6'"
                ...
                <div class="form__row form__row_declaration form__row_declaration_payment p_0">
                  <div class="column justify_center align_flex-end position_relative">
                    ...
                    <input type="text" autocomplete="off" autocapitalize=off v-mask-regexp="'\d*[a-z._-][0-9a-z\d._-]*'"
                         ...
                         :data-vv-as="$t('unified-profile.profile-settings.address-page')" :placeholder="'Адрес страницы'"
