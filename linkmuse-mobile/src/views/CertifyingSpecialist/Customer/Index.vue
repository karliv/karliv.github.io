  ...
  <div class="lm-vs-landing-talent">
    <div class="lm-vs-landing-talent-header vs">
      <div class="lm-vs-landing-talent-header-wrap">
        ...
        <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="min-width: 196px" class="lm-white-button middle">
          Подать заявку
        </a>
      </div>
    </div>
    ...
    <div class="lm-vs-landing-talent-line first">
      ...
      <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="min-width: 196px" class="lm-primary-button middle">
        Подать заявку
      </a>
    </div>
    ...
    <div class="lm-vs-landing-talent-line first no-mt">
      ...
      <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="min-width: 236px" class="lm-primary-button middle">
        начать зарабатывать
      </a>
    </div>
