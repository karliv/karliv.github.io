...
const FILTERS_OPTIONS = {
  ...
  [filters.ROLE]: {
    ...
    field: 'roleIds',
    phrase ({ source }, _this) {
      return source ? _this.$t(`dictionary.casting-role.${source.name}.declension.single.rod`) : ''
    }
  },
  // [filters.CITY]: {
  //   type: IN,
  ...
  //     return source ? _this.$te(`dictionary.city.${city}.declension.single.dat`) ? _this.$te(`dictionary.city.${city}.declension.single.dat`) : `г. ${source.text}` : ''
  //   },
  //   inQuery (_this, query) {
  //     let param = false
  //
  ...
  [filters.CATEGORY]: {
    ...
    field: 'categoryIds',
    phrase ({ source }, _this) {
      return source ? _this.$t(`dictionary.casting-category.${source.name}.declension.single.rod`) : ''
    }
  }
}
