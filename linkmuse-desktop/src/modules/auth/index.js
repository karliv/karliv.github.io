...
class Auth {
  ...
  getHasEmail () {
    return Vue.prototype.$cookies.get('has_email')
  }

  getFcmToken () {
    return Vue.prototype.$cookies.get('fcm_token')
  }

  storeSession (data) {
    Vue.prototype.$cookies.set('id_token', data.token, { expires, path: '/' })
    Vue.prototype.$cookies.set('refresh_token', data.token, { expires, path: '/' })
    ...
    if (data.hasOwnProperty('has_email')) {
      Vue.prototype.$cookies.set('has_email', data.has_email, { expires, path: '/' })
    }
  }
  ...
  storeSessionClient (data) {
    ...
    if (data.hasOwnProperty('has_email')) {
      Cookies.set('has_email', data.has_email, { expires, path: '/' })
    }
  }
  ...
  removeSession () {
    ...
    Vue.prototype.$cookies.remove('has_email')
