...
export function CLEAR_SINGLE_ORDER_DATA (state) {
  state.orders.single.data = null
}
...
export function SET_ORDERS_CUSTOMER_DATA (state, services) {
  state.orders.customer.data = services
}
...
export function SET_ORDERS_ARCHIVAL_DATA (state, services) {
  state.orders.archival.data = services
}
...
export function SET_SETTINGS_STUDIOS_LOADING (state, value) {
  state.settings.studios.loading = value
}

export function SET_SETTINGS_STUDIOS_DATA (state, value) {
  state.settings.studios.data = value
}

export function SET_SETTINGS_STUDIOS_ERROR (state, value) {
  state.settings.studios.error = value
}
...
export default {
  ...
  SET_SETTINGS_STUDIOS_LOADING,
  SET_SETTINGS_STUDIOS_DATA,
  SET_SETTINGS_STUDIOS_ERROR
}
