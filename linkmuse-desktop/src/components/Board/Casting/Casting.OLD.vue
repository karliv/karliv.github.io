    ...
    <div :class="['d-card', { 'd-card_premium': (isCatalogPage === true && isFasten === true) }]">
      ...
      <div class="section d-card__section">
        ...
        <div class="d-row w_100 justify_between mt_5">
          <template v-if="(isAuthorized === true && isCurrentUser === false && isResponded === false && forTrusted === true && canRespond === false)">
            <div class="d-column d-card__disabled_respond">
              ...
              <template v-if="(isExecutor === true)">
                <template v-if="((portfolioBadQuality === null || hasPortfolio === false) && hasCertification === false)">
                  ...
                  <div class="d-card__disabled_respond__description mt_3">
                    <span>Или обновите профиль самостоятельно.</span>
                    <a :href="`${user.href}/portfolio`" class="d-link mt_1">Обновить</a>
                  </div>
                </template>
              ...
              <div class="d-row">
                <template v-if="(isCurrentUser === false)">
                  <template v-if="(isAuthorized === true && canRespondOnCasting === false)">
                    <tooltip :class="['d-tooltip_declaration']" effect="scale" placement="bottom" :content="'Отклики ограничены, поскольку ваши фото не соответствуют правилам сайта'">
