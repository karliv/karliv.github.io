<template>
  <div class="d-upload-zone d-input_row mb_12">
    <label class="d-input__label">Фото</label>
    <div class="column">
      <lm-dropzone :label="'добавить фото'" :mediaModal="false" :max-items="20" :class="['form__dropzone', 'd-upload-zone__field', { 'error': (verrors.has('photos')) }]"
