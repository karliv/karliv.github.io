  ...
  <div class="personal-list__item d-row">
    ...
    <div class="flex-beetwen-center w_100">
      ...
      <template v-if="(isCurrentUser === true)">
        <a href="javascript:void(0)" @click.stop.prevent="_handleClickDestroyPartner" :class="['d-row', 'd-text_bold', 'w_auto', { 'color_gray-3': true }]">Удалить</a>
      </template>
    </div>
  </div>
</template>
