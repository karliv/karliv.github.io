  ...
  <div class="lm-vs-landing-talent">
    <div class="lm-vs-landing-talent-header vs">
      <div class="lm-vs-landing-talent-header-wrap">
        ...
        <div class="desc">Вы получаете регулярные заказы и возможность выбирать удобный для себя график. Работая по фиксированной стоимости за съемки до 30 минут, вы сможете совмещать несколько заказов сразу и зарабатывать больше.
          <br><br>
        ...
        <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="width: max-content; margin: 0 auto; border: 1px solid #ffffff; color:#ffffff;" class="d-btn">Подать заявку</a>
    ...
    <div class="lm-vs-landing-talent-line">
      ...
      <div class="lm-vs-landing-talent-getting-wrap">
        ...
        <div class="lm-vs-landing-talent-getting-item">
          ...
          <span>Съемка и монтаж видеовизитки</span>
        </div>
        <div class="lm-vs-landing-talent-getting-item">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewBox="0 0 48 48">
          ...
          <span>Монтаж шоурила</span>
        </div>
      </div>
      <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="width: max-content; margin: 0 auto;" class="d-btn d-btn_primary">Подать заявку</a>
    </div>
    <div class="lm-vs-landing-talent-line">
      ...
      <div class="lm-vs-landing-cooperation-wrap">
        <div class="lm-vs-landing-cooperation-item">
          <span>Дополнительный <br> источник дохода</span>
        </div>
        <div class="lm-vs-landing-cooperation-item">
          <span>Гарантированные <br> онлайн-выплаты</span>
        </div>
        <div class="lm-vs-landing-cooperation-item">
          <span>Индивидуальный <br> график</span>
        </div>
        <div class="lm-vs-landing-cooperation-item">
          <span>Техническую <br> поддержку</span>
        </div>
      </div>
      <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="width: max-content; margin: 0 auto;" class="d-btn d-btn_primary">Подать заявку</a>
    </div>
    <div class="lm-vs-landing-talent-line">
      ...
      <div class="lm-vs-landing-talent-getting-wrap">
        ...
        <div class="lm-vs-landing-talent-getting-item">
          ...
          <span>Статус Самозанятости, ИП или ЮР лица</span>
        </div>
        <div class="lm-vs-landing-talent-getting-item">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewBox="0 0 48 48">
      ...
      <a @click="_handleClickCreateResponse" href="javascript:void(0)" style="width: max-content; margin: 0 auto;" class="d-btn d-btn_primary">Начать зарабатывать</a>
    </div>
...
export default {
  ...
  computed: {
    ...
    max_price () {
      return this._.max(this.services.map(service => Number.parseFloat(service['price'])))
    },
    hasGeo () {
  ...
  methods: {
    ...
    _handleClickCreateResponse () {
      if (this.isAuthorized === false) {
        const { href } = this.$router.resolve({ name: 'certifying.customer.register' })
